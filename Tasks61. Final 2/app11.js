    ...
    if (!hasError) {
        ...
        if (saveButton) {
            ...
            tr.addEventListener("dblclick", function (event) {
                ...
                document.querySelector(`[name="code"]`).value = this.children[0].innerText;
                document.querySelector(`[name="name"]`).value = this.children[1].innerText;
                document.querySelector(`[name="price"]`).value = this.children[2].innerText;
