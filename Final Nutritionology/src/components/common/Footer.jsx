            ...
            <div className="footer__row">
                <div className="footer__row_contacts">
                    <div className="footer__row_contacts_logo">
                        <img className="footer__row_contacts_logo_img" src="./img/logo.png" alt="С заботой о здоровье!" title="С заботой о здоровье!"/>
                    ...
                    <div className="footer__row_contacts_services">
                        ...
                        <ul className="footer__row_contacts_services_ul">
                            ...
                            <li className="footer__row_contacts_services_ul_li"><a href="#">Индивидуальная консультация</a></li>
                            <li className="footer__row_contacts_services_ul_li"><a href="#">Персональная программа</a></li>
                        </ul>
                    </div>
                    <div className="footer__row_contacts_info">
                        ...
                        <div className="footer__row_contacts_info_phone">
                            <img className="footer__row_contacts_info_phone_image" src="../FINAL/img/phone.webp" alt="phone"/>
                        ...
                        <div className="footer__row_contacts_info_email">
                            <img className="footer__row_contacts_info_email_image" src="../FINAL/img/email.png" alt="phone"/>
                        ...
                        <div className="footer__row_contacts_info_whatsapp">
                            <img className="footer__row_contacts_info_whatsapp_image" src="../FINAL/img/whatsapp.png" alt="phone"/>
