            ...
            <tbody>
                {props.products.map((item, index) => {
                    return <tr key={item.id}>
                        ...
                        <td>{item.name}</td>
                        <td className="img"><img src={`/img/${item.image}`} className="card-img-top" alt={item.title} /></td>
                        ...
                        <td colSpan={4} align="right">{item.price * item.quantity}</td>
                        <td>
                ...
                <tr>
                    ...
                    <td colSpan={5} align="right">{getResult()}</td>
                </tr>
