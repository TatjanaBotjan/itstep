...
const mapStateToProps = state => { // mapStateToProps передача хранилища
    return {
        user: state.product.user
    }
};

const mapDispatchToProps = dispatch => ({ // mapDispatchToProps gthtlfxf ghjlernf
    onProductAdd: (product) => { // onProductAdd - Название ф-ции в компоненете
        dispatch({
